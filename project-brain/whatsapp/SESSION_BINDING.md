# WhatsApp Session Binding Architecture

## 2026-05-29 Active Binding

PostgreSQL runtime state:

* Active connected session: `61b8e755-2b65-428a-9d49-de6c4206aa80`
* Bound phone number: `919137730283`
* Tenant: `eee18224-de89-41c3-9fb3-e4fdebb532eb`
* Session name: `testing`

Former session `a14b378d-4971-4263-bbe0-b8c63aba71be` appeared in old logs but is no longer tracked by the database; backend logs showed `Ignored event for untracked session` for it.

This document details the multi-tenant session architecture and active socket binding used inside the Baileys coordinator engine.
